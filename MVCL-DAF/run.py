...
def parse_arguments():
    ...
    parser.add_argument('--method', type=str, default='MVCL-DAF', help="which method to use.")
    ...
    parser.add_argument('--num_workers', type=int, default=8, help="The number of workers to load data.") # 原为8 2可以
    ...
    parser.add_argument('--cache_path', type=str, default='/huggingfaceCache/bert-large-uncased', help="The caching directory for pre-trained models.")   
    ...
    parser.add_argument("--config_file_name", type=str, default='MVCL_DAF_MIntRec.py', help = "The name of the config file.")
...
def run(args, data, logger, labels_weight, ind_args = None):
    debug_args = {}
    ...
    for result in itertools.product(*debug_args.values()):
        ...
        work(args, data, logger, labels_weight, debug_args, ind_args)
...
if __name__ == '__main__':
    ...
    run(args, data, logger, labels_weight=labels_weight)
